...
from colorize import colorize, to_dark  # noqa: E402
...
def main():
    ...
    for i, gid in enumerate(ids, start=1):
        ...
        # The dark copy the course ships was styled to a lower standard than
        # the light one - ragged column widths, no cell padding - so the dark
        # pages are made from the light markup with its colours swapped. Both
        # themes then lay out identically.
        parts_dark = [to_dark(x) for x in parts_light]
